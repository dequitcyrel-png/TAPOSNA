...
class ProjectController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'status' => 'nullable|in:pending,draft,published,ongoing,active,completed,archived',
        ], [
        ...
        */
        ...
        $project = $teacher->projects()->create([
            ...
            'status' => in_array($validated['status'] ?? '', ['pending','draft','published','ongoing','active','completed','archived']) ? $validated['status'] : 'draft',
